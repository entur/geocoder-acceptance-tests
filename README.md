...
Test cases are JSON files in `test_cases/` (v2) and `v3/test_cases/` (v3). See the [guide to writing solid tests](https://github.com/pelias/acceptance-tests/wiki/Guide-to-writing-solid-tests).
